...
export function shareText(label: string | null): string {
  return label
    ? `${label} is among the Singapore forests zoned for development under the URA Master Plan 2025.`
    : "Which forests will Singapore lose under the URA Master Plan 2025?";
}
